                    ...
                    <div className="tooltip" style={styles.tooltip}>
                        <div>
                            <div className="list" style={styles.list}>
                                ...
                                <div className="list_item" style={styles.list_item}>
                                    <div className="highlighter_wrapper" style={styles.highlighter_wrapper}>
                                        <div>
                                            <span>
                                                <div onClick={highlightWithColor} className="highlighter" style={styles.highlighter}>
                                ...
                                {/* ============= ADD SELECTION TO NOTE ============= */}

                                <div className="list_item" style={styles.list_item}>
                                    <div className="highlighter_wrapper" style={styles.highlighter_wrapper}>
                                        <div>
                                            <span>
                                                <div onClick={addSelectionAsNote} className="highlighter " style={styles.highlighter}>
